...
describe 'table_header_matcher' do
	...
	describe 'without <thead> element' do
		...
		it 'should handle multiple header rows' do
			response = mock_model(Object, :body => '<table id="my_id"><tr><th>h1</th><th>h2</th></tr><tr><th>h3</th><th>h4</th></tr><tr><td>"regular"</td><td>"row"</td></tr></table>')
			response.should have_table_header('my_id', [['h1', 'h2'], ['h3', 'h4']])
		end
	end
end